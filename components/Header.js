      ...
      {searchInput && (
        <div className="flex flex-col col-span-3 mx-auto ">
          ...
          <div className="flex mb-2">
            <button
              onClick={resetInput}
              className="flex-grow text-gray-500 hover:text-gray-800 hover:font-bold"
            >
              Cancel
            </button>
            <button
              onClick={search}
              className="flex-grow text-red-400 hover:text-red-500 hover:font-bold"
            >
              Search
            </button>
          </div>
